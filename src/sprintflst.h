...
extern HAMLIB_EXPORT( int ) amp_sprintf_func(char *str, int len, setting_t func);
...
extern HAMLIB_EXPORT( int ) amp_sprintf_status(char *str, int len, amp_status_t status);
