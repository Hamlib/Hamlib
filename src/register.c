...
DEFINE_INITRIG_BACKEND(tci);
DEFINE_INITRIG_BACKEND(atsmini);
...
} rig_backend_list[RIG_BACKEND_MAX] =
{
    ...
    { RIG_TCI, RIG_BACKEND_TCI, RIG_FUNCNAMA(tci) },
    { RIG_ATS_MINI, RIG_BACKEND_ATS_MINI, RIG_FUNCNAMA(atsmini) },
    { 0, NULL }, /* end */
};
