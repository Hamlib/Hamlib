...
struct cmdparams ic7300_extcmds[] =
{
    ...
    { {.s = RIG_LEVEL_USB_AF}, CMD_PARAM_TYPE_FUNC, C_CTL_MEM, S_MEM_PARM, SC_MOD_RW, 2, {0x00, 0x60}, CMD_DAT_LVL, 2 },
    { {.s = RIG_PARM_NONE} }
};
...
struct cmdparams ic9700_extcmds[] =
{
    ...
    { {.s = RIG_LEVEL_USB_AF}, CMD_PARAM_TYPE_FUNC, C_CTL_MEM, S_MEM_PARM, SC_MOD_RW, 2, {0x01, 0x06}, CMD_DAT_LVL, 2 },
    { {.s = RIG_PARM_NONE} }
};
...
struct cmdparams ic705_extcmds[] =
{
    ...
    { {.s = RIG_LEVEL_USB_AF}, CMD_PARAM_TYPE_FUNC, C_CTL_MEM, S_MEM_PARM, SC_MOD_RW, 2, {0x01, 0x13}, CMD_DAT_LVL, 2 },
    { {0} }
};
