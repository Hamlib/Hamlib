...
const struct rig_caps ic7300_caps =
{
    ...
    .rx_range_list1 =   { 
        {kHz(30), MHz(199.999999), IC7300_ALL_RX_MODES, -1, -1, IC7300_VFOS}, RIG_FRNG_END, 
        {MHz(400), MHz(470), IC7300_ALL_RX_MODES, -1, -1, IC7300_VFOS}, RIG_FRNG_END 
        },
    .tx_range_list1 =   {
        FRQ_RNG_HF(1, IC7300_OTHER_TX_MODES, W(2), W(10), IC7300_VFOS, RIG_ANT_1),
        FRQ_RNG_60m(1, IC7300_OTHER_TX_MODES, W(2), W(10), IC7300_VFOS, RIG_ANT_1),
        FRQ_RNG_6m(1, IC7300_OTHER_TX_MODES, W(2), W(10), IC7300_VFOS, RIG_ANT_1),
        FRQ_RNG_4m(1, IC7300_OTHER_TX_MODES, W(2), W(10), IC7300_VFOS, RIG_ANT_1),
        FRQ_RNG_2m(1, IC7300_OTHER_TX_MODES, W(2), W(10), IC7300_VFOS, RIG_ANT_1),
        FRQ_RNG_70cm(1, IC7300_OTHER_TX_MODES, W(2), W(10), IC7300_VFOS, RIG_ANT_1),
