...
/**
 * Measured power in dBm using gdyuldin gui.
 * GUI: v0.33.4; Base: v1.1.6_r9
 * 
 * icom_get_level dBm    S unit
 * 2 5  5  0.0000 -121   s1 (-48)
 * 2 10 10 0.0000 -114.6 s2 (-42) 
 * cant measure   -109   s3 (-36)
 * 2 18 18 0.0000 -103   s4 (-30)
 * 2 24 24 0.0000 -97.0  s5 (-24)
 * 2 27 27 0.0000 -91.1  s6 (-18)
 * 2 32 32 0.0000 -85.2  s7 (-12)
 * 2 37 37 0.0000 -78.9  s8 (-6)
 * 2 42 42 0.0000 -73.0  s9
 * 2 45 45 0.0000 -67.9  +5
 * 2 49 49 0.0000 -62.9  +10 
 * 2 52 52 0.0000 -58.1  +15
 * 2 56 56 0.0000 -53.1  +20
 * 2 60 60 0.0000 -48.1  +25
 * 2 63 63 0.0000 -43.1  +30
 * 2 68 68 0.0000 -38.0  +35
 * 2 71 71 0.0000 -33.0  +40
 */
#define X6100_STR_CAL { 17, \
    { \
        {   0, -54 }, /* first one is made up, radio does not output less than 5 */ \
        {   5, -48 }, \
        {  10, -42 }, \
        {  18, -30 }, \
        {  24, -24 }, \
