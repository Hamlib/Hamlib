...
static struct icom_priv_caps g90_priv_caps =
{
    ...
    .agc_levels = {
        ...
        { .level = RIG_AGC_SLOW, .icom_level = 0x02 },
        { .level = RIG_AGC_AUTO, .icom_level = 0x03 },
 ...
 *
 * RIG_LEVEL_RFPOWER: at full power, G90 firmware replies with a
